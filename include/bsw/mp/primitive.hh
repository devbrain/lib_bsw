// https://github.com/jehugaleahsa/primitive.git
#ifndef PRIMITIVE_HPP
#define PRIMITIVE_HPP

#include <type_traits>
#include <bsw/mp/arithmetic_traits.hh>
#include <iosfwd>
...
namespace primitives {
	...
	class primitive final {
	 ...
	 public:
		...
		constexpr primitive (U const& value) noexcept
			: m_value (value) {}

		template <typename U, typename = std::enable_if_t<is_promotion<U, T>::value >>
		constexpr primitive (primitive<U> const& other) noexcept
			: m_value (other.get ()) {}

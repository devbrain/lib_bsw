...
#ifndef BSW_IO_ZLIB_OSTREAM_HH
#define BSW_IO_ZLIB_OSTREAM_HH
...
namespace bsw::io {
   ...
   */
  class BSW_EXPORT deflating_stream_buf : public buffered_stream_buf {
    public:
  ...
  class BSW_EXPORT deflating_ios : public virtual std::ios {
    public:
  ...
  ///     deflater.close();
  ///     ostr.close();
  class BSW_EXPORT deflating_output_stream : public std::ostream, public deflating_ios {
    public:
  ...
  /// This stream compresses all data passing through it
  /// using zlib's deflate algorithm.
  class BSW_EXPORT  deflating_input_stream : public std::istream, public deflating_ios {
    public:
      /// Creates a DeflatingIOS for compressing data read
      /// from the given input stream.

...
#ifndef BSW_ARCHIVE_MEMORY_STREAM_BUF_HH
#define BSW_ARCHIVE_MEMORY_STREAM_BUF_HH
...
//
  ...
  class BSW_EXPORT memory_ios : public virtual std::ios
  ...
  class BSW_EXPORT memory_input_stream : public memory_ios, public std::istream
...
/// Destroys the MemoryInputStream.
  ...
  class BSW_EXPORT memory_output_stream : public memory_ios, public std::ostream
/// An input stream for reading from a memory area.
  {
    public:
...
//
  ...
  memory_stream_buf<ch, tr>::seekoff (off_type off, std::ios_base::seekdir way,

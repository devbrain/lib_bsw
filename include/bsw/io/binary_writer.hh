...
#ifndef BSW_BINARY_WRITER_HH
#define BSW_BINARY_WRITER_HH
...
namespace bsw::io {
  ...
  class BSW_EXPORT binary_writer
      ...
      /// in such a case.
  {
    public:
      ...
      [[nodiscard]] stream_byte_order_t byte_order () const;
...
//
  ...
  inline binary_writer::stream_byte_order_t binary_writer::byte_order () const {
#if !BSW_IS_LITTLE_ENDIAN

...
#ifndef BSW_BASE64_HH
#define BSW_BASE64_HH
...
namespace bsw::io {
  ...
  class BSW_EXPORT base64_encoder_buf : public unbuffered_stream_buf
  ...
  class BSW_EXPORT base64_encoder_ios : public virtual std::ios
...
/// order of the stream buffer and base classes.
  ...
  class BSW_EXPORT base64_encoder : public base64_encoder_ios, public std::ostream
...
/// not updated to match the buffer's state.
  ...
  class BSW_EXPORT base64_decoder_buf : public unbuffered_stream_buf
  ...
  class BSW_EXPORT base64_decoder_ios : public virtual std::ios
...
/// order of the stream buffer and base classes.
  ...
  class BSW_EXPORT base64_decoder : public base64_decoder_ios, public std::istream

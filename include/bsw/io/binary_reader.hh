...
#ifndef BSW_BINARY_READER_HH
#define BSW_BINARY_READER_HH
...
namespace bsw::io {
  class BSW_EXPORT binary_reader
...
//
  ...
  inline binary_reader::stream_byte_order binary_reader::byte_order () const {
    ...
    return m_flip_bytes ? LITTLE_ENDIAN_BYTE_ORDER : BIG_ENDIAN_BYTE_ORDER;
#else

...
#ifndef BSW_ARCHIVE_BUFFERED_STREAM_BUF_HH
#define BSW_ARCHIVE_BUFFERED_STREAM_BUF_HH
...
namespace bsw::io {
  ...
  class BSW_EXPORT basic_buffered_stream_buf : public std::basic_streambuf<ch, tr>

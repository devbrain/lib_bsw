...
#ifndef BSW_ARCHIVE_UNBUFFERED_STREAM_BUF_HH
#define BSW_ARCHIVE_UNBUFFERED_STREAM_BUF_HH
...
namespace bsw::io {
  ...
  class BSW_EXPORT basic_unbuffered_stream_buf : public std::basic_streambuf<ch, tr>

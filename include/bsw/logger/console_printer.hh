...
namespace bsw::logger {
	class console_printer : public simple_printer {
	 public:
		...
		void before_log_record (std::ostream& stream, record_ptr_t record);
		void after_log_record (std::ostream& stream, record_ptr_t record);
		void before_print_args (std::ostream& stream, record_ptr_t record);
		void after_print_args (std::ostream& stream, record_ptr_t record);
	};
} // ns logger

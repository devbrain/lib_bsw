...
#ifndef BSW_NUMBER_FORMATTER_HH
#define BSW_NUMBER_FORMATTER_HH
...
namespace bsw {
  class BSW_EXPORT number_formatter
      ...
      ///      an existing string.
  {
    public:
      ...
      static const unsigned NF_MAX_FLT_STRING_LEN = BSW_MAX_FLT_STRING_LEN;

...
#ifndef BSW_NUMERIC_STRING_HH
#define BSW_NUMERIC_STRING_HH
...
// binary numbers are supported, thus 64 (bits) + 1 (string terminating zero)
  inline constexpr auto BSW_MAX_INT_STRING_LEN = 65;
// value from strtod.cc (double_conversion::kMaxSignificantDecimalDigits)
  inline constexpr auto BSW_MAX_FLT_STRING_LEN = 780;

  inline constexpr auto BSW_FLT_INF = "inf";
  inline constexpr auto BSW_FLT_NAN = "nan";
  inline constexpr auto BSW_FLT_EXP = 'e';
...
//
  ...
  {
    char res[BSW_MAX_INT_STRING_LEN] = {0};
    std::size_t size = BSW_MAX_INT_STRING_LEN;
...
//
  ...
  BSW_EXPORT void float_to_str (char* buffer,
                     int bufferSize,
                     float value,
  ...
  BSW_EXPORT void float_to_fixed_str (char* buffer,
                           int bufferSize,
                           float value,
                           int precision);
  /// Converts a float value to string. Converted string must be shorter than bufferSize.
  ...
  BSW_EXPORT std::string& float_to_str (std::string& str,
                             float value,
                             int precision = -1,
                             int width = 0,
                             char thSep = 0,
  ...
  BSW_EXPORT std::string& float_to_fixed_str (std::string& str,
                                   float value,
                                   int precision,
                                   int width = 0,
                                   char thSep = 0,
  ...
  BSW_EXPORT void double_to_str (char* buffer,
                      int bufferSize,
                      double value,
  ...
  BSW_EXPORT void double_to_fixed_str (char* buffer,
                            int bufferSize,
                            double value,
                            int precision);
  /// Converts a double value to string. Converted string must be shorter than bufferSize.
  ...
  BSW_EXPORT std::string& double_to_str (std::string& str,
                              double value,
                              int precision = -1,
                              int width = 0,
                              char thSep = 0,
  ...
  BSW_EXPORT std::string& double_to_fixed_str (std::string& str,
                                    double value,
                                    int precision = -1,
                                    int width = 0,
                                    char thSep = 0,
  ...
  BSW_EXPORT float str_to_float (const char* str,
                      const char* inf = BSW_FLT_INF, const char* nan = BSW_FLT_NAN);
  ...
  BSW_EXPORT bool str_to_float (const std::string&, float& result,
  ...
  BSW_EXPORT double str_to_double (const char* str,
                        const char* inf = BSW_FLT_INF, const char* nan = BSW_FLT_NAN);
  /// Converts the string of characters into double-precision floating point number.


  BSW_EXPORT bool str_to_double (const std::string& str, double& result,
                      char decSep = '.', char thSep = ',',
                      const char* inf = BSW_FLT_INF, const char* nan = BSW_FLT_NAN);
  /// Converts the string of characters into double-precision floating point number.
  /// The conversion result is assigned to the result parameter.

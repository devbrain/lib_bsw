...
#if defined(BSW_PATH_INCLUDE)
    auto pfx1 = utils::string_factory (BSW_PATH_INCLUDE);
#else
    auto pfx1 = bsw::string_factory("");
#endif
#if defined(BSW_PATH_PRIVATE)
    auto pfx2 = utils::string_factory (BSW_PATH_PRIVATE);
#else
    auto pfx2 = bsw::string_factory("");
#endif

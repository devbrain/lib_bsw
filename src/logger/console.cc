...
namespace logger
{
    class console_c : public local_device
    {
    public:
    ...
    // -----------------------------------------------------------------
    bool console_c::_do_print(record_ptr_t record)
    {
    ...
    device_ptr_t console_device(predicate_ptr_t predicate)
    {
        ...
        device_ptr_t console(new console_c(fmatter, predicate));
        return console;
    }
} // ns logger

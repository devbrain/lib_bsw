...
#ifndef BSW_ZSTD_WRAPPER_H
#define BSW_ZSTD_WRAPPER_H
...
int
zstd_deflate_init2 (z_streamp strm, int level, int method, int windowBits, int memLevel, int strategy,
